...
TSIGPATH='/global/u2/j/jaws/.ssh/jaws_TSIG_key'
...
update del ${DOLLAR}PSCRATCHDNSNAME A
update add ${DOLLAR}PSCRATCHDNSNAME 120 A ${DOLLAR}HOSTIP
send
EOF
...
if [ ${DOLLAR}? -eq 0 ]; then
    ...
    dig +short ${DOLLAR}PSCRATCHDNSNAME
