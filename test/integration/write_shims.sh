...
SERVICES=("rpc-server" "run-daemon" "transfer-daemon" "perf-metrics-daemon" "task-log-consumer")
...
function write_venv_shims {
    ...
    envsubst < "$DIR/templates/task-log-consumer.sh" > "$JAWS_BIN_DIR/task-log-consumer"
