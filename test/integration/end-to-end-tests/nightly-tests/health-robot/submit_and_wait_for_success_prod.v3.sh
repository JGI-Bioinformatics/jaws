...
function submitJob {
    ...
    jaws run submit fq_count.wdl fq_count.json ${SITE}_${RELEASE}_out_dir $SITE > ${SITE}_${RELEASE}_run_submit 2> ${SITE}_${RELEASE}.stderr
	...
	rm -r ${SITE}_${RELEASE}.stderr ${SITE}_${RELEASE}_out_dir ${SITE}_${RELEASE}_run_submit
