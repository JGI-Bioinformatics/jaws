...
class Client:
    ...
    def queue(self, site: str = "ALL") -> dict:
        ...
        return Runs(self._request("POST", "runs/search", query))
    ...
    def status(self, run_id: int, verbose: bool = False) -> dict:
        ...
        if verbose is True:
            ...
            urn = f'run/{run_id}'
        return Run(self._request("GET", urn))
