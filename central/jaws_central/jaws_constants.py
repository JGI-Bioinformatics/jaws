...
run_status_msg = {
    ...
    "staged": "Your run inputs have been transferred and are ready to submit to Cromwell",
    "invalid input": "The run was uploaded but some of the required files were missing..",
    "submitted": "The run has been submitted to Cromwell but not yet queued for execution",
    "submission failed": "The run was submitted to Cromwell but rejected due to invalid input.",
    "queued": "Your run has been submitted to Cromwell but has not begun execution yet",
    "running": "The run is being executed; you can check the task status for more detail",
    "succeeded": "The run has completed successfully and is waiting for the outfiles to be organized",
    "failed": "The run has failed; the complete working dir shall be returned",
